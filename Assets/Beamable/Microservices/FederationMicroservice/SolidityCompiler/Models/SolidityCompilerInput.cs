...
namespace Beamable.Microservices.FederationMicroservice.SolidityCompiler.Models
{
    public class SolidityCompilerInput
    {
        ...
        [JsonProperty("language")] public string Language { get; set; } = "Solidity";

        [JsonProperty("sources")] public InputSource Sources { get; set; }

        [JsonProperty("settings")] public OutputSettings Settings { get; set; }

        public class InputSource
        {
            [JsonProperty("contract")] public InputContract Contract { get; set; } = null!;
        ...
        {
            [JsonProperty("outputSelection")] public Selection OutputSelection { get; set; } = null!;

            public class Selection
            {
                [JsonProperty("contract")] public IDictionary<string, List<string>> Contract { get; set; } = null!;
            }
        }
    }
}